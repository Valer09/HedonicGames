...
/**
 * Testing.Test methods for the class JGraphXAdapter.
 */
public class JGraphXAdapterTest
{

    /**
     * Testing.Test scenarios under normal conditions.
     */
    @Test
    public void genericTest()
    {
        ...
        String v1 = "Structures.Vertex 1";
        String v2 = "Structures.Vertex 2";
        String v3 = "Structures.Vertex 3";
        String v4 = "Structures.Vertex 4";
    ...
    public void listenerTest()
    {
        ...
        jGraphT.addEdge(v1, v2, "Structures.Edge 1");
        jGraphT.addEdge(v1, v3, "Structures.Edge 2");
        jGraphT.addEdge(v1, v4, "Structures.Edge 3");
        jGraphT.addEdge(v2, v3, "Structures.Edge 4");
        jGraphT.addEdge(v3, v4, "Structures.Edge 5");
    ...
    public void notListenableTest()
    {
        ...
        jGraphT.addEdge(v1, v2, "Structures.Edge 1");
        jGraphT.addEdge(v1, v3, "Structures.Edge 2");
        jGraphT.addEdge(v2, v3, "Structures.Edge 3");

        JGraphXAdapter<String, String> graphX = new JGraphXAdapter<String, String>(jGraphT);

        jGraphT.addVertex(v4);
        jGraphT.addEdge(v1, v4, "Structures.Edge 4");
        jGraphT.addEdge(v3, v4, "Structures.Edge 5");
    ...
    /**
     * Testing.Test if duplicate Entries are saved only once.
     */
    @Test
