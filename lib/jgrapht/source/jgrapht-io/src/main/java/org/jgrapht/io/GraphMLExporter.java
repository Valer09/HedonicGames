    ...
    GraphExporter<V, E>
{
        ...
        ComponentAttributeProvider<E> edgeAttributeProvider)
    {
        super(
            vertexIDProvider,
            Objects.requireNonNull(edgeIDProvider, "Structures.Edge ID provider must not be null"));
    ...
    public void setVertexLabelAttributeName(String vertexLabelAttributeName)
    {
        if (vertexLabelAttributeName == null) {
            throw new IllegalArgumentException("Structures.Vertex label attribute name cannot be null");
        }
    ...
    public void setEdgeLabelAttributeName(String edgeLabelAttributeName)
    {
        if (edgeLabelAttributeName == null) {
            throw new IllegalArgumentException("Structures.Edge label attribute name cannot be null");
        }
    ...
    public void setEdgeWeightAttributeName(String edgeWeightAttributeName)
    {
        if (edgeWeightAttributeName == null) {
            throw new IllegalArgumentException("Structures.Edge weight attribute name cannot be null");
        }
