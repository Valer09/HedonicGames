    ...
    GraphImporter<V, E>
{
    ...
    public void setEdgeWeightAttributeName(String edgeWeightAttributeName)
    {
        this.edgeWeightAttributeName = Objects
            .requireNonNull(edgeWeightAttributeName, "Structures.Edge weight attribute name cannot be null");
    }
            ...
            throws SAXException
        {
            ...
            case EDGE:
                ...
                String sourceId = findAttribute(EDGE_SOURCE, attributes)
                    .orElseThrow(() -> new IllegalArgumentException("Structures.Edge source missing"));
                String targetId = findAttribute(EDGE_TARGET, attributes)
                    .orElseThrow(() -> new IllegalArgumentException("Structures.Edge target missing"));
