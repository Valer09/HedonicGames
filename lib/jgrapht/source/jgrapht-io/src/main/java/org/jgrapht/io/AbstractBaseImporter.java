...
abstract class AbstractBaseImporter<V, E>
{
    ...
    {
        this.vertexProvider =
            Objects.requireNonNull(vertexProvider, "Structures.Vertex provider cannot be null");
        this.edgeProvider = Objects.requireNonNull(edgeProvider, "Structures.Edge provider cannot be null");
        this.vertexUpdater = Objects.requireNonNull(vertexUpdater, "Structures.Vertex updater cannot be null");
