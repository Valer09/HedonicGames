...
public class KolmogorovMinimumWeightPerfectMatchingTest
{
    ...
    /**
     * Testing.Test on a triangulation of 8 points Points: (2, 10), (9, 11), (10, 4), (11, 15), (12, 5),
     * (12, 6), (13, 12), (14, 11)
     */
    @Test
    ...
    /**
     * Testing.Test on an empty graph
     */
    @Test
    public void testGetMatching1()
    {
        ...
        KolmogorovMinimumWeightPerfectMatching<Integer, DefaultWeightedEdge> perfectMatching =
            new KolmogorovMinimumWeightPerfectMatching<>(graph, options);
    ...
    /**
     * Testing.Test on a graph with an odd cycle
     */
    @Test
    ...
    /**
     * Testing.Test on a $K_{3,3}$
     */
    @Test
    public void testGetMatching5()
    {
        int[][] edges = new int[][] { { 1, 4, 7 }, { 1, 5, 5 }, { 1, 6, 2 }, { 2, 4, 1 },
            { 2, 5, 3 }, { 2, 6, 4 }, { 3, 4, 7 }, { 3, 5, 10 }, { 3, 6, 7 } };
        test(edges, 12);
    }
    ...
    {
        int[][] edges = new int[][] { { 1, 4, 7 }, { 1, 5, 3 }, { 1, 6, 9 }, { 2, 4, 8 },
            { 2, 5, 2 }, { 2, 6, 9 }, { 3, 4, 6 }, { 3, 5, 1 }, { 3, 6, 10 } };
        test(edges, 17);
    }

    /**
     * Testing.Test on a $K_{4}$
     */
    @Test
    public void testGetMatching7()
    {
        int[][] edges = new int[][] { { 1, 2, 2 }, { 1, 3, 5 }, { 1, 4, 1 }, { 2, 3, 5 },
            { 2, 4, 2 }, { 3, 4, 1 } };
        test(edges, 3);
    }

    /**
     * Testing.Test on a $K_{5}$ with a dummy edge (3,6)
     */
    @Test
    public void testGetMatching8()
    {
        int[][] edges =
            new int[][] { { 1, 2, 1 }, { 1, 3, 4 }, { 1, 4, 7 }, { 1, 5, 10 }, { 2, 3, 5 },
                { 2, 4, 7 }, { 2, 5, 10 }, { 3, 4, 10 }, { 3, 5, 2 }, { 4, 5, 3 }, { 3, 6, 8 } };
        test(edges, 12);
    }

    /**
     * Testing.Test on a $K_{5}$ with a dummy edge (1,6)
     */
    @Test
    public void testGetMatching9()
    {
        int[][] edges =
            new int[][] { { 1, 2, 1 }, { 1, 3, 6 }, { 1, 4, 1 }, { 1, 5, 1 }, { 2, 3, 6 },
                { 2, 4, 6 }, { 2, 5, 5 }, { 3, 4, 7 }, { 3, 5, 8 }, { 4, 5, 8 }, { 1, 6, 8 } };
        test(edges, 20);
    }
    ...
    {
        int[][] edges =
            new int[][] { { 1, 2, 4 }, { 1, 3, 4 }, { 1, 4, 6 }, { 1, 5, 8 }, { 2, 3, 8 },
                { 2, 4, 10 }, { 2, 5, 8 }, { 3, 4, 4 }, { 3, 5, 9 }, { 4, 5, 4 }, { 1, 6, 9 } };
        test(edges, 21);
    }
    ...
    {
        int[][] edges =
            new int[][] { { 1, 2, 5 }, { 1, 3, 1 }, { 1, 4, 8 }, { 1, 5, 1 }, { 2, 3, 2 },
                { 2, 4, 8 }, { 2, 5, 1 }, { 3, 4, 8 }, { 3, 5, 5 }, { 4, 5, 10 }, { 1, 6, 8 } };
        test(edges, 17);
    }
    ...
    {
        int[][] edges =
            new int[][] { { 1, 2, 2 }, { 1, 3, 6 }, { 1, 4, 3 }, { 1, 5, 2 }, { 2, 3, 7 },
                { 2, 4, 7 }, { 2, 5, 7 }, { 3, 4, 4 }, { 3, 5, 4 }, { 4, 5, 2 }, { 1, 6, 2 } };
        test(edges, 11);
    }

    /**
     * Testing.Test on a $K_{5}$ with a dummy edge (5,4)
     */
    @Test
    public void testGetMatching13()
    {
        int[][] edges =
            new int[][] { { 2, 0, 8 }, { 2, 0, 5 }, { 2, 1, 9 }, { 3, 0, 2 }, { 3, 1, 6 },
                { 3, 2, 7 }, { 4, 0, 3 }, { 4, 1, 5 }, { 4, 2, 5 }, { 4, 3, 7 }, { 5, 4, 6 } };
        test(edges, 17);
    }

    /**
     * Testing.Test on a $K_{5}$ with a dummy edge (5,1)
     */
    @Test
    ...
    /**
     * Testing.Test on a $K_{6}$ with edges with zero weight
     */
    @Test
    public void testGetMatching16()
    {
        int[][] edges = new int[][] { { 1, 2, 3 }, { 1, 3, 2 }, { 1, 4, 8 }, { 1, 5, 10 },
            { 1, 6, 8 }, { 2, 3, 1 }, { 2, 4, 4 }, { 2, 5, 8 }, { 2, 6, 0 }, { 3, 4, 8 },
            { 3, 5, 5 }, { 3, 6, 0 }, { 4, 5, 7 }, { 4, 6, 0 }, { 5, 6, 0 } };
        test(edges, 6);
    }

    /**
     * Testing.Test on a triangulation of 8 points
     */
    @Test
    ...
    /**
     * Testing.Test on a triangulation of 10 points
     */
    @Test
    ...
    /**
     * Testing.Test on a triangulation of 10 points Points: (1, 2), (1, 8), (3, 5), (3, 11), (3, 12), (5,
    ...
    /**
     * Testing.Test on a triangulation of 10 points Points: (1, 7), (1, 11), (4, 5), (6, 5), (7, 8), (9, 1),
    ...
    /**
     * Testing.Test on a triangulation of 10 points Points: (4, 5), (5, 14), (6, 12), (7, 11), (9, 1), (9,
    ...
    /**
     * Testing.Test on a triangulation of 10 points Points: (3, 3), (3, 10), (4, 12), (5, 13), (8, 4), (10,
    ...
    /**
     * Testing.Test on a triangulation of 10 points Points: (1, 15), (4, 2), (7, 13), (8, 15), (9, 5), (10,
    ...
    /**
     * Testing.Test on a triangulation of 10 points Points: (1, 6), (2, 14), (5, 5), (7, 10), (9, 8), (9,
    ...
    /**
     * Testing.Test on a triangulation of 10 points Points: (1,4), (5, 10), (5, 13), (8, 7), (9, 8), (10,
    ...
    /**
     * Testing.Test on a triangulation of 10 points Points: (2, 9), (4, 13), (6, 5), (6, 12), (8, 4), (8,
    ...
    /**
     * Testing.Test on a triangulation of 20 points Points: (2, 24), (4, 8), (5, 21), (5, 24), (6, 12), (10,
    ...
    /**
     * Testing.Test on triangulation of 50 points
     */
    @Test
    ...
    /**
     * Testing.Test on triangulation of 100 points
     */
    @Test
    ...
    /**
     * Testing.Test on triangulation of 200 points
     */
    @Test
    ...
    /**
     * Testing.Test on triangulation of 300 points
     */
    @Test
    ...
    /**
     * Testing.Test on triangulation of 400 points
     */
    @Test
    ...
    /**
     * Testing.Test on triangulation of 500 points
     */
    @Test
    ...
    /**
     * Testing.Test on an unweighted $K_{50}$
     */
    @Test
    ...
    /**
     * Testing.Test on a weighted $K_{50}$
     */
    @Test
    ...
    /**
     * Testing.Test on a small pseudograph
     */
    @Test
    public void testGetMatching39()
    {
        ...
        KolmogorovMinimumWeightPerfectMatching<Integer, DefaultWeightedEdge> solver =
            new KolmogorovMinimumWeightPerfectMatching<>(graph);
        checkMatchingAndDualSolution(solver.getMatching(), solver.getDualSolution());
    }

    /**
     * Testing.Test on a pseudograph
     */
    @Test
    ...
    /**
     * Testing.Test on a graph with odd number of vertices
     */
    ...
    /**
     * Testing.Test on a $K_{3}$ with a zero-degree vertex
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testing.Test on triangulation of 9 points with a zero-degree vertex
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testing.Test on triangulation of 99 points with a zero-degree vertex
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testing.Test on a 3-regular graph with no perfect matching
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testing.Test on a 7-regular graph without perfect matching: |V| = 64, |max. cardinality matching| =
     * 29
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testing.Test on a 9-regular graph without perfect matching: |V| = 100, |max. cardinality matching| =
     * 46
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Testing.Test on a 11-regular graph without perfect matching: |V| = 144, |max. cardinality matching| =
     * 67
     */
    @Test(expected = IllegalArgumentException.class)
            ...
            for (V vertex : entry.getKey()) {
                for (E edge : graph.edgesOf(vertex)) {
                    if (matchedEdges.contains(edge)
                        && !entry.getKey().contains(Graphs.getOppositeVertex(graph, edge, vertex)))
                    {
