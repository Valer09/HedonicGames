...
/**
 * Testing.Test class for AStarShortestPath implementation
 *
...
public class AStarShortestPathTest
{
    ...
    /**
     * Testing.Test on a graph with a path from the source node to the target node.
     */
    @Test
    ...
    /**
     * Testing.Test on a graph where there is no path from the source node to the target node.
     */
    @Test
