    ...
    Serializable
{
     ...
     * for non-simple graphs. Structures.Edge repetition is permitted, the start and end point points ($v_0$
        ...
        double weight)
    {
        ...
        if (vertexList == null && edgeList == null)
            throw new IllegalArgumentException("Structures.Vertex list and edge list cannot both be null!");
            ...
            if (edgeList == null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (graph.getEdge(u, v) == null)
                        throw new InvalidGraphWalkException(
                            "The vertexList does not constitute to a feasible path. Structures.Edge (" + u
