    ...
    CrossComponentIterator<V, E, DepthFirstIterator.VisitColor>
{
    ...
    {
        /**
         * Structures.Vertex has not been returned via iterator yet.
         */
        WHITE,

        /**
         * Structures.Vertex has been returned via iterator, but we're not done with all of its out-edges yet.
         */
        GRAY,

        /**
         * Structures.Vertex has been returned via iterator, and we're done with all of its out-edges.
         */
        BLACK
    }
