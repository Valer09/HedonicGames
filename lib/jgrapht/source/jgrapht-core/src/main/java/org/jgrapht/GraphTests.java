...
public abstract class GraphTests
{
    ...
    /**
     * Testing.Test whether a graph is empty. An empty graph on n nodes consists of n isolated vertices with
     * no edges.
     * 
    ...
    /**
     * Testing.Test whether a graph is complete. A complete undirected graph is a simple graph in which
    ...
    /**
     * Testing.Test if the inspected graph is connected. A graph is connected when, while ignoring edge
    ...
    /**
     * Testing.Test whether a directed graph is weakly connected.
     * 
     * <p>
     * This method does not performing any caching, instead recomputes everything from scratch. In
     * case more control is required use {@link ConnectivityInspector} directly.
    ...
    /**
     * Testing.Test whether a graph is strongly connected.
     * 
     * <p>
     * This method does not performing any caching, instead recomputes everything from scratch. In
    ...
    /**
     * Testing.Test whether an undirected graph is a tree.
     *
     * @param graph the input graph
     * @param <V> the graph vertex type
     * @param <E> the graph edge type
    ...
    /**
     * Testing.Test whether an undirected graph is a forest. A forest is a set of disjoint trees. By
    ...
    /**
     * Testing.Test whether a graph is <a href="https://en.wikipedia.org/wiki/Overfull_graph">overfull</a>.
    ...
    /**
     * Testing.Test whether an undirected graph is a
    ...
    /**
     * Testing.Test whether a graph is bipartite.
     * 
     * @param graph the input graph
     * @param <V> the graph vertex type
     * @param <E> the graph edge type
    ...
    /**
     * Testing.Test whether a partition of the vertices into two sets is a bipartite partition.
     * 
     * @param graph the input graph
    ...
    /**
     * Testing.Test whether a graph is Eulerian. An undirected graph is Eulerian if it is connected and each
     * vertex has an even degree. A directed graph is Eulerian if it is strongly connected and each
     * vertex has the same incoming and outgoing degree. Testing.Test whether a graph is Eulerian. An
