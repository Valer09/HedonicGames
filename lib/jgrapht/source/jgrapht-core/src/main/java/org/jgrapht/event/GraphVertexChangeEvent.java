    ...
    GraphChangeEvent
{
    ...
    /**
     * Structures.Vertex added event. This event is fired after a vertex is added to a graph.
     */
    public static final int VERTEX_ADDED = 13;

    /**
     * Structures.Vertex removed event. This event is fired after a vertex is removed from a graph.
     */
