...
public class BergeGraphInspector<V, E>
{
     ...
     * 
     * @param g A Graph
     * @param y Structures.Vertex whose X-completeness is to assess
     ...
     * 
     * @param g A Graph
     * @param a A Structures.Vertex
     * @param b A Structures.Vertex
