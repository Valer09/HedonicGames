    ...
    GraphChangeEvent
{
    ...
    /**
     * Structures.Edge added event. This event is fired after an edge is added to a graph.
     */
    public static final int EDGE_ADDED = 23;

    /**
     * Structures.Edge removed event. This event is fired after an edge is removed from a graph.
     */
    public static final int EDGE_REMOVED = 24;

    /**
     * Structures.Edge weight updated event. This event is fired after an edge weight is updated in a graph.
     */
